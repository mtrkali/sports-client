...
const MyProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            ...
            res.data.map(d => setUserProfile(d));
        }
        fetchUser()
    }, [user, axiosSecure])
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10 w-full max-w-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-center">
                    <div className="bg-gray-100 rounded-xl p-4 shadow-sm">
                        ...
                        <p className="text-xl font-semibold text-indigo-600">{dateFormater(userProfile.last_signIn)}</p>
                    </div>
                    <div className="bg-gray-100 rounded-xl p-4 shadow-sm">
                        <p className="text-gray-500 text-sm">Membership Type</p>
                        <p className="text-xl font-semibold text-indigo-600">User</p>
                    </div>
                </div>
